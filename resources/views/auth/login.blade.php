...
@section('content')
    <div class="page-content page-auth">
        <section class="section-store-auth" data-aos="fade-up" data-aos-delay="100">
            <div class="container">
                <div class="row align-items-center row-login">
                    <div class="col-lg-6 text-center">
                        <img src="{{ asset('images/login-placeholder.png') }}" class="w-50 mb-4 mb-lg-none" alt="" />
                    </div>
                    <div class="col-lg-5">
                        ...
                        <form method="POST" action="{{ route('login') }}" class="mt-3">
                            ...
                            <button type="submit" class="btn btn-success w-75 d-grid mt-4" >Sign in to my account</button>
                            <a href="{{ route('register') }}" class="btn btn-signup w-75 d-grid mt-2">Sign up</a>
                        </form>
                    </div>
                </div>
            </div>
